...
<html lang="en">
    ...
    <body>
                                                    ...
                                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="#">
                                                        <fieldset>
                                                            <div class="control-group">											
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" required="required" class="input-medium" id="kid" name="kid" value="" />
                                                                </div> <!-- /controls -->				
                                                            </div> <!-- /control-group -->
                                                            <div class="control-group">
                                                            ...
                                                            <div class="form-actions">
                                                                <button type="submit" value="-" id=k name=k></button> 
                                                            </div> <!-- /form-actions -->
                                                        </fieldset>
                                                    </form>
                                                </div>
        ...
        ?>	<a href="uploads/<?php echo $pid; ?>.pdf">Submit</a>
