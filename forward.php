...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Forward to Specialist</title>
                                                    ...
                                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="adddetails.php">
                                                        <fieldset>
                                                            <div class="control-group">											
                                                                ...
                                                                <div class="controls">
                                                                    <input type="radio" name="dept" value="">ENT<br>
                                                                    <input type="radio" name="dept" value="">Cardiology<br>
                                                                    <input type="radio" name="dept" value="">Orthopedics<br>
                                                                    <input type="radio" name="dept" value="">Hematology<br>
                                                                    <input type="radio" name="dept" value="">Neurology
