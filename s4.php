        ...
        <div id="container">
            ...
            <div id="sidebar1">
                <div id="subsidebar1">
                    ...
                    <div id="subsidebar2"><a href="s4.php">Home</a>
                    </div>
            ...
            <div id="mainContent">
                <div id="mainContent1">
                    <div id="middletxtheadermain">
                        <div id="middletxtheader"><div align="center"><!--<img src="images/n1.jpg" alt="Login Please" width="650" height="250" /> --></div></div>
                    </div>
                    <div id="middletxt">
                            ...
                            <table width="100%" border=0>
                                <tr>
                                    <td height="22"><table align="center" width="100%" border=0>
                                            <tr>
                                                <th colspan="3" bgcolor="pink" id="formhedear"><center><h3>WE CARE YOU</h3></center></th>
                                            </tr>

                                            <tr>
                                                <td rowspan="4" id="formhedear"><div align="right"><img src="images/n2.jpg" alt="Login Please" width="300" height="200" /> </div></td>
                                            </tr>
            ...
            <div id="footer">
                (C) Copyright RockWall Nuerology Pvt. Limited
                <!-- end #footer -->
            </div>
            <!-- end #container -->
        </div>
