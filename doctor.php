                                                ...
                                                <div class="tab-pane active" id="1">
                                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="adddetails.php">
                                                        <fieldset>
                                                            ...
                                                            <div class="control-group">											
                                                                <div class="controls">
                                                                    <input type="text" required="required" class="input-medium" id="tobacco" name="tobacco" value="" />
                                                                    <span class="help-inline"></span>
                                                                </div> <!-- /controls --></div> <!-- /control-group -->				
                                                            <div class="control-group">											
                                                                <label class="control-label" for="firstname">Alcohol</label>
                                                                <div class="controls">
                                                                    <input type="text" required="required" class="input-medium" id="alcohol" name="alcohol" value="" />
                                                                    <span class="help-inline"></span>
                                                                </div> <!-- /controls -->				
                                                            </div> <!-- /control-group -->
                                                            <div class="control-group">											
